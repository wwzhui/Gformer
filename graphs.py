...
class PygStructureDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        for g in graphs:
            ...
            # print("-------------------------------------")
            # print("gatgnn_glob_feat shape:", gatgnn_glob_feat.shape)
            # print("atoms_index序号",atoms_index)
            # # print("atoms_index的type",type(atoms_index))
            # print("atoms_index的size",atoms_index.size)
            #
            # print("atoms_index长度", len(atoms_index))
            # print("-------------------------------------")
