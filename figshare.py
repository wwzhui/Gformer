...
# def get_request_data(js_tag="jdft_3d-8-18-2021.json"):
#     """Get data with progress bar."""
#     # 构造ZIP文件的完整路径
#     #zfile_path = os.path.join(os.path.dirname(__file__), "data", "dft_3d", js_tag.replace(".json", ".zip"))
#     #zfile_path = "/home/u2023170749/code/0823/comformer/comformer/mydata/dft_3d/jdft_3d-8-18-2021.json.zip"
#     base_path = "/home/u2023170749/code/0823/comformer/comformer/mydata/dft_3d"
#     file_name = "jdft_3d-8-18-2021.json.zip"  # 确保这里的文件名是正确的
#     zfile_path = os.path.join(base_path, file_name)
#     # 确保ZIP文件存在
#     if not os.path.isfile(zfile_path):
#         print(zfile_path)
#         print(f"ZIP file {zfile_path} does not exist11111111111.")
#         return None
#
#     # 使用zipfile模块打开ZIP文件并解压
#     with zipfile.ZipFile(zfile_path, "r") as zipObj:
#         # 解压到当前脚本所在目录
#         #zipObj.extractall(os.path.dirname(__file__))
#         zipObj.extractall("/home/u2023170749/code/0823/comformer/comformer/mydata/dft_3d/")
#
#     # 构造JSON文件的完整路径
#     json_file_path = "/home/u2023170749/code/0823/comformer/comformer/mydata/dft_3d/jdft_3d-8-18-2021.json"
#
#     # 确保JSON文件存在
#     if not os.path.isfile(json_file_path):
#         print(f"JSON file {json_file_path} does not exist after extraction.")
#         return None
#
#     # 删除ZIP文件
...
def get_request_data(js_tag="jdft_3d-8-18-2021.json"):
    # 构造JSON文件的完整路径
    json_file_path = "/home/u2023110576/data/alldataset/jdft_3d-8-18-2021.json"
    # 确保JSON文件存在
    if not os.path.isfile(json_file_path):
        print(f"JSON file {json_file_path} does not exist after extraction.")
        return None
...
def data(dataset="dft_2d"):
    ...
    #    os.remove(zfile)
    # data = loadjson(path)
    #dat = get_request_data(js_tag=js_tag)
    if dataset == "dft_3d":
      json_file_path = "/home/u2023110576/data/alldataset/jdft_3d-8-18-2021.json"
    # 确保JSON文件存在
      if not os.path.isfile(json_file_path):
    ...
    if dataset == "megnet":
      json_file_path = "/home/u2023110576/data/alldataset/megnet.json"
    # 确保JSON文件存在
      if not os.path.isfile(json_file_path):
        print(f"JSON file {json_file_path} does not exist after extraction.")
        return None
