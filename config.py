...
class TrainingConfig(BaseSettings):
    ...
    # train_ratio: Optional[float] = 0.0002  ##batch_size=4
    # val_ratio: Optional[float] = 0.0001
    # test_ratio: Optional[float] = 0.0001
    # train_ratio: Optional[float] = 0.002  ##batch_size=4
    # val_ratio: Optional[float] = 0.001
    # test_ratio: Optional[float] = 0.001
